...
<template>
    <li class="rounded-lg p-4">
        <div class="bg-light-gray flex flex-col w-10 h-24 items-center	justify-center rounded-lg gap-3">
            ...
            <svg :class="hoveringMinus" @mouseenter="hoveringMinus = 'fill-moderate-blue'" class="cursor-pointer"
                ...
                xmlns="http://www.w3.org/2000/svg">
                <path
                    d="m9.3 2.7.5-.2.2-.4V.7c0-.1 0-.3-.2-.4a.9.9 0 0 0-.5-.1H.8L.2.3 0 .7v1.4c0 .2 0 .3.2.4l.6.2h8.5Z" />
            </svg>
        </div>
    </li>
</template>