...
<template>
    <li class="w-full" :key="id">
        ...
        <ReplyVue :userEmail="userEmail" v-show="store.state.replySelected == id" :id="id" :isMineMessage="isMineMessage" />
