...
<template>
    <article class=" grid grid-cols-card-layout rounded-lg p-4 pt-6 w-3/4 m-auto bg-white hover:drop-shadow">
        ...
        <UserBadgeVue :user-email="userEmail" :date="date" />
        <button class="flex items-center gap-2.5">
            ...
            <p class="font-bold" :class="currentColor == '#5357B6' ? 'text-moderate-blue' : 'text-light-grayish-blue'">
                Reply</p>
        </button>
